...
import 'package:chat/features/chat/presentation/widgets/message_widgets/message_audio_widget.dart';
import 'package:chat/features/chat/presentation/widgets/message_widgets/message_video_widget.dart';
  ...
  Widget build(BuildContext context) {
    if (type == MessageTypeConst.textMessage) {
      ...
      return Text(
        ...
        maxLines: 2,
        style: const TextStyle(
            color: textColor, fontSize: 12, overflow: TextOverflow.ellipsis),
      );
    }
  }
}
